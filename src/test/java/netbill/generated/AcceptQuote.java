...
public class AcceptQuote extends uk.ac.lancaster.scc.turtles.stellar.core.protocol.bspl.BSPLMessage {
    ...
    AcceptQuote(
        ...
        super(AcceptQuoteSchema.instance().getName(), sender, receiver, bindings);
	}

    AcceptQuote(uk.ac.lancaster.scc.turtles.stellar.core.protocol.bspl.BSPLMessage message) {
        super(message);
    }
