...
public class Transfer extends uk.ac.lancaster.scc.turtles.stellar.core.protocol.bspl.BSPLMessage {
    ...
    Transfer(
        ...
        super(TransferSchema.instance().getName(), sender, receiver, bindings);
	}

    Transfer(uk.ac.lancaster.scc.turtles.stellar.core.protocol.bspl.BSPLMessage message) {
        super(message);
    }
